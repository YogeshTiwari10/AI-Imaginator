    ...
    <section className='max-w-7xl mx-auto'>
      ...
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[15px] max-w-[500px]'>
          Create stunning images generated by AI Imaginator using Open AI
        </p>
      </div>
      ...
      <form className='max-w-3xl mt-16' onSubmit={handleSubmit}>
        ...
        <div className="mt-5 flex gap-5">
          <button
            ...
            className=" text-white w-full bg-green-700 font-medium rounded-md text-sm sm:w-full px-5 py-2.5 text-center"
          >
